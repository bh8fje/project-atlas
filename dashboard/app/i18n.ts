...
export const translations: Record<Language, Translation> = {
  zh: {
    ...
    milestones: [['本地项目目录管理', '选择扫描目录，识别项目并按设定间隔检查变化'], ['明确的项目组成与发布记录', '区分项目组成、项目关系与实时分析'], ['建设阶段功能详情', '可展开每个阶段，查看已实现功能'], ['专业清晰的界面文案', '中文统一功能含义，其他语言保持一致']],
  ...
  ko: {
    ...
    milestones: [['로컬 프로젝트 폴더 관리', '스캔 폴더를 선택하고 프로젝트를 식별하여 정기적으로 변경 점검'], ['명확한 프로젝트 구성과 릴리스 기록', '프로젝트 구성, 프로젝트 관계, 실시간 분석을 구분'], ['개발 단계 기능 상세', '각 단계를 펼쳐 구현된 기능을 확인'], ['명확하고 전문적인 화면 문구', '중국어로 정한 의미를 모든 언어에 일관되게 적용']],
